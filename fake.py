...
model = quantize_model(model_fp16, weight_quant, act_quant, quantize_bmm_input)
print("Smoothing model weights...")
smooth_lm(model, act_scales, 0.5)
print("Evaluating...")
acc_w8a8 = evaluator.evaluate(model)
print(f'SmoothQuant W8A8 quantized model accuracy: {acc_w8a8}.weight_quant={weight_quant},act_quant={act_quant},quantize_bmm_input={quantize_bmm_input}')
